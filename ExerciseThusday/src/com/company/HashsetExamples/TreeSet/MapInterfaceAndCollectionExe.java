...
//
        ...
        hset.add(Integer.valueOf("2"));
        hset.add(Integer.valueOf("3"));
        ...
        System.out.println("HashSet elements are being copied into an array. Now the array contains...");
    ...
    public void hashMap(){
        ...
        System.out.println("Here is the list of String hash map");
    ...
    public void addingSpecificIndexElementInArray(){
        System.out.println("####### Adding an element at a specific index in ArrayList #######");
